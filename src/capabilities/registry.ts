...
import { listToolManifests, type ToolManifestEntry } from './tool-manifest.js';
import { isGitHubConfigured, setGitHubToken } from '../utils/github.js';
import type { SkillDiscovery } from '../skills/index.js';
...
export class CapabilityRegistry {
  ...
  getToolManifests(): ToolManifestEntry[] {
    return listToolManifests(this.getToolNames());
  }
  ...
  getSkillSummaries(): SkillDiscovery[] {
    return this.skillLoader?.getDiscovered() || [];
  }
}
