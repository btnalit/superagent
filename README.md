...
<p align="center">
  <strong>Goal-contract AI agent runtime with traceable execution, tool authority, skills, evaluation, and evolution proposals.</strong>
</p>

<p align="center">
  Built on Mercury. Remembers what matters, asks before it acts, and exposes runtime traces through CLI or Telegram.
</p>

<p align="center">
  <a href="https://github.com/btnalit/superagent/actions/workflows/ci.yml"><img src="https://github.com/btnalit/superagent/actions/workflows/ci.yml/badge.svg" alt="CI"></a>
...
```bash
git clone https://github.com/btnalit/superagent.git
cd superagent
npm ci
npm run build
npm start
...
| `/runtime` | Show the latest Agent Runtime trace |
| `/trace` | Alias for `/runtime` |
| `/proposals` | Show recent data-only evolution proposals |
...
MIT. Original Mercury work © [Cosmic Stack](https://github.com/cosmicstack-labs); Superagent adaptations are maintained by [btnalit](https://github.com/btnalit).
...
Open an issue at [btnalit/superagent](https://github.com/btnalit/superagent/issues).

---

## Community

1. **Issues** — Use [GitHub Issues](https://github.com/btnalit/superagent/issues) for bug reports, runtime questions, and improvement proposals.
